# DEV-ENV-002B ta-finalize: thin wrapper; all logic lives in ta_tools.py.
#   .\.claude\scripts\ta-finalize.ps1 -Task <id> [-Commit [-Push]] [-Message <text>] [-Json]
#   Default is check-only with zero git mutation; -Commit and -Push each ask for an interactive y/yes.
